create_clock -add -name main_clk -period 10.00 [get_ports {clk_in1_0}];

set_property PACKAGE_PIN R16        [get_ports { reset_0 }]; 
...
set_property PACKAGE_PIN AA8        [get_ports { din_0 }];    
...
set_property PACKAGE_PIN AA9       [get_ports { dout_0 }];    
